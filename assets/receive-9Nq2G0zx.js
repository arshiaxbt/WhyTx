import{B as e,E as t,V as n,b as r,g as i,j as a,r as o,y as s}from"./ModalController-DGu250uY.js";import{b as c,c as l,d as u,g as d,l as f,o as p,p as m,s as h,u as g,v as _}from"./wui-text-B0fkXhri.js";import"./wui-image-DofV_3-B.js";import"./wui-qr-code-B-EYHGVX.js";var v=d`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`,y=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},b=class extends _{constructor(){super(...arguments),this.networkImages=[``],this.text=``}render(){return c`
      <button>
    ...
    </wui-flex>`}};b.styles=[m,u,v],y([l({type:Array})],b.prototype,`networkImages`,void 0),y([l()],b.prototype,`text`,void 0),b=y([f(`wui-compatible-network`)],b);var x=d`
...
`,S=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},C=class extends _{constructor(){super(),this.unsubscribe=[],this.address=o.getAccountData()?.address,this.profileName=o.getAccountData()?.profileName,this.network=o.state.activeCaipNetwork,this.unsubscribe.push(o.subscribeChainProp(`accountState`,e=>{e?(this.address=e.address,this.profileName=e.profileName):a.showError(`Account not found`)}),o.subscribeKey(`activeCaipNetwork`,e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw Error(`w3m-wallet-receive-view: No account provided`);let e=t.getNetworkImage(this.network);return c` <wui-flex
    ...
    </wui-flex>`}networkTemplate(){let n=o.getAllRequestedCaipNetworks(),r=o.checkIfSmartAccountEnabled(),a=o.state.activeCaipNetwork,s=n.filter(e=>e?.chainNamespace===a?.chainNamespace);if(i(a?.chainNamespace)===e.ACCOUNT_TYPES.SMART_ACCOUNT&&r)return a?c`<wui-compatible-network
        @click=${this.onReceiveClick.bind(this)}
        text="Only receive assets on this network"
        .networkImages=${[t.getNetworkImage(a)??``]}
      ></wui-compatible-network>`:null;let l=(s?.filter(e=>e?.assets?.imageId)?.slice(0,5)).map(t.getNetworkImage).filter(Boolean);return c`<wui-compatible-network
      @click=${this.onReceiveClick.bind(this)}
