import{b as e,c as t,d as n,g as r,l as i,p as a,v as o}from"./wui-text-B0fkXhri.js";import"./wui-image-DofV_3-B.js";import"./wui-shimmer-89Z_Y1n0.js";var s=r`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`,c=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},l={lg:`lg-regular`,md:`lg-regular`,sm:`md-regular`},u={lg:`lg`,md:`md`,sm:`sm`},d=class extends o{constructor(){super(...arguments),this.size=`md`,this.disabled=!1,this.text=``,this.loading=!1}render(){return this.loading?e` <wui-flex alignItems="center" gap="01" padding="01">
    ...
    `}imageTemplate(){return this.imageSrc&&this.chainImageSrc?e`<wui-flex class="left-image-container">
      ...
      >${this.text}</wui-text
    >`}};d.styles=[a,n,s],c([t()],d.prototype,`size`,void 0),c([t()],d.prototype,`imageSrc`,void 0),c([t()],d.prototype,`chainImageSrc`,void 0),c([t({type:Boolean})],d.prototype,`disabled`,void 0),c([t()],d.prototype,`text`,void 0),c([t({type:Boolean})],d.prototype,`loading`,void 0),d=c([i(`wui-token-button`)],d);