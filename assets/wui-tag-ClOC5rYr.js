import{M as e,b as t,rt as n}from"./ModalController-DGu250uY.js";import{b as r,c as i,g as a,l as o,p as s,v as c}from"./wui-text-B0fkXhri.js";import{t as l}from"./ConstantsUtil-C1qdKpER.js";var u={getTabsByNamespace(t){return t&&t===n.CHAIN.EVM?e.state.remoteFeatures?.activity===!1?l.ACCOUNT_TABS.filter(e=>e.label!==`Activity`):l.ACCOUNT_TABS:[]},isValidReownName(e){return/^[a-zA-Z0-9]+$/gu.test(e)},isValidEmail(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/gu.test(e)},validateReownName(e){return e.replace(/\^/gu,``).toLowerCase().replace(/[^a-zA-Z0-9]/gu,``)},hasFooter(){let n=t.state.view;if(l.VIEWS_WITH_LEGAL_FOOTER.includes(n)){let{termsConditionsUrl:t,privacyPolicyUrl:n}=e.state,r=e.state.features?.legalCheckbox;return!(!t&&!n||r)}return l.VIEWS_WITH_DEFAULT_FOOTER.includes(n)}},d=a`
  :host {
    display: flex;
...
`,f=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},p=class extends c{constructor(){super(...arguments),this.variant=`accent`,this.size=`md`,this.icon=void 0}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;let e=this.size===`md`?`md-medium`:`sm-medium`,t=this.size===`md`?`md`:`sm`;return r`
    ...
    `}};p.styles=[s,d],f([i()],p.prototype,`variant`,void 0),f([i()],p.prototype,`size`,void 0),f([i()],p.prototype,`icon`,void 0),p=f([o(`wui-tag`)],p);export{u as t};